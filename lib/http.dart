...
Future<ArticArtworkPayload> fetchArtworks() async {
  final url =
      'http://api.artic.edu/api/v1/artworks?page=1&limit=10&fields=id,api_link,title,thumbnail,artist_display,date_display,medium_display,dimensions,main_reference_number';
  try {
